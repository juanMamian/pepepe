...
export default {
  ...
  computed: {
    usuarioResponsableProyecto: function () {
      ...
      if (
        this.esteProyecto.responsables.includes(this.usuario.id)
      ) {
        return true;
      }
      return false;
    ...
    usuarioParticipanteProyecto: function () {
      ...
      if (
        this.esteProyecto.participantes.includes(this.usuario.id)
      ) {
        return true;
      }
      return false;
    ...
    permisosEdicion: function () {
      if (
        ...
        this.usuario.permisos == "superadministrador"
      ) {
        return true;
      }
      return false;
  ...
  methods: {
    ...
    asumirComoResponsable() {
      console.log(
        `enviando id ${this.usuario.id} para la lista de responsables del proyecto con id ${this.esteProyecto.id}`
      );
      this.enviandoQueryResponsables = true;
      this.$apollo
        .mutate({
