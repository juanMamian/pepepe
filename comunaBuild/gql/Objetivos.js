    ...
    Mutation: {
        crearObjetivoEnProyecto(_, { idProyecto, posicion }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    var nuevoObjetivo = yield new Objetivo_1.ModeloObjetivo({ idProyectoParent: idProyecto, idForo: idNuevoForo, diagramaProyecto: { posicion } });
        ...
        setPosicionObjetivoDiagramaProyecto: function (_, { idObjetivo, nuevaPosicion }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
