...
exports.resolvers = {
    ...
    Query: {
        ...
        trabajosDeGrupoDeUsuario: function (_, { idUsuario }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    Mutation: {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!elNodo.nodoParent || !elNodo.nodoParent.idNodo || !elNodo.nodoParent.tipo) {
                    ...
                    while (administradoresElNodo.length < 1 && idNodoParent) { //Buscar responsables heredados
                        try {
                            var elParent = yield Trabajo_1.ModeloTrabajo.findById(idNodoParent).exec();
                            if (!elParent) {
                                elParent = yield Objetivo_1.ModeloObjetivo.findById(idNodoParent).exec();
                            }
                            if (elParent) {
        ...
        crearRequerimentoEntreNodosSolidaridad(_, { idNodoRequiriente, idNodoRequerido }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                //Prevenir loop
                var listaRequeridos = [];
                var actualRequeridos = nodoRequerido.vinculos.filter(v => v.tipo === 'requiere').map(v => v.idRef);
                var loop = false;
                while (actualRequeridos.length > 0) {
                    console.log(`Revisando loop en ${actualRequeridos.length} nodos de siguiente nivel:`);
                    console.log(`${actualRequeridos}`);
                    try {
                        var tRequeridos = (yield Trabajo_1.ModeloTrabajo.find({ _id: { $in: actualRequeridos } }).select("vinculos").exec()) || [];
                        var oRequeridos = (yield Objetivo_1.ModeloObjetivo.find({ _id: { $in: actualRequeridos } }).select("vinculos").exec()) || [];
                        console.log(`Encontrados ${tRequeridos.length} trabajos y ${oRequeridos.length} objetivos`);
                        var requeridos = tRequeridos.concat(oRequeridos);
                    }
                    catch (error) {
                        console.log(`Error descargando nodos requeridos for checking loop posibilities`);
                        throw new apollo_server_express_1.ApolloError("Error conectando con la base de datos");
                    }
                    console.log(`Descargados ${requeridos.length} nodos requeridos`);
                    if (requeridos.some(r => r.id === idNodoRequiriente)) {
                        loop = true;
                        break;
                    }
                ...
                if (loop) {
                    console.log(`Habria loop con la creación de este vínculo. Cancelando`);
                    throw new apollo_server_express_1.UserInputError("Estos nodos no se pueden vincular");
                }
                //Introducir vínculo
        ...
        crearObjetivo(_, { posicion }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    var nuevoObjetivo = yield new Objetivo_1.ModeloObjetivo({ idForoResponsables: idNuevoForo, diagramaGrupo: { posicion } });
        ...
        eliminarObjetivo(_, { idObjetivo, idGrupo }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    yield Grupo_1.ModeloGrupo.findByIdAndUpdate(idGrupo, { $pull: { idsObjetivos: idObjetivo } });
                }
                catch (error) {
                    console.log("Error eliminando objetivo. E: " + error);
                    throw new apollo_server_express_1.ApolloError("Error introduciendo el objetivo en el grupo");
                }
                console.log(`eliminado`);
                return true;
            });
        ...
        editarKeywordsObjetivo(_, { idGrupo, idObjetivo, nuevoKeywords }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
                let credencialesUsuario = contexto.usuario;
                try {
                    var elObjetivo = yield Objetivo_1.ModeloObjetivo.findById(idObjetivo).exec();
        ...
        crearTrabajo(_, { idGrupo, posicion }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                console.log(`Nuevo foro creado`);
                try {
                    var nuevoTrabajo = yield new Trabajo_1.ModeloTrabajo({ idGrupoParent: idGrupo, idForoResponsables: idNuevoForo, diagramaGrupo: { posicion } });
        ...
        eliminarTrabajo(_, { idTrabajo, idGrupo }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    yield Grupo_1.ModeloGrupo.findByIdAndUpdate(idGrupo, { $pull: { idsTrabajos: idTrabajo } });
                }
                catch (error) {
        ...
        editarKeywordsTrabajo(_, { idGrupo, idTrabajo, nuevoKeywords }, contexto) {
            return __awaiter(this, void 0, void 0, function* () {
                let credencialesUsuario = contexto.usuario;
                try {
                    var elTrabajo = yield Trabajo_1.ModeloTrabajo.findById(idTrabajo).exec();
