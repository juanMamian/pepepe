<template>
  ...
  >
    ...
    <div id="zonaListas" @click.self.stop="idNodoSeleccionado=null">
      ...
      />
      <span v-show="abierta && listaSeleccionada==='materiales'" id="tituloListaMateriales">Materiales {{nodoSeleccionado?' relevantes para el nodo '+nodoSeleccionado.nombre:''}}</span>
      <lista-materiales
